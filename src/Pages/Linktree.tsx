...
const Linktree: React.FC = () => {
  ...
  const links = [
    ...
    {
      name: "GitHub",
      url: "https://github.com/AbdulSamiWorks",
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/abdul-sami-42904125a",
    ...
    {
      name: "YouTube",
      url: "https://youtube.com/@abdulsamifl", // Update if active
      icon: <FaYoutube className="w-6 h-6" />,
      color: "bg-red-100",
      description: "Watch my AI and dev videos",
    },
    {
      name: "Peerlist",
      url: "https://peerlist.io/sami7", // Add only if active
    ...
    {
      name: "Instagram",
      url: "https://instagram.com/abdulsamifl", // Optional
    ...
    {
      name: "Email Me",
      url: "mailto:abdulsami34421@gmail.com",
    ...
    <div className="font-codefont min-h-screen w-full bg-[#FEFFF0] p-4 pt-32 md:pt-28 md:p-8">
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          ...
          >
            Designing intelligent, privacy-focused web applications and AI
            models using Federated Learning, Transformers, and modern
            development tools.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <div className="relative inline-block">
            ...
            <a
              href="mailto:abdulsami34421@gmail.com"
