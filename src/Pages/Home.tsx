            ...
            <motion.div variants={itemVariants} className="space-y-8">
              ...
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                ...
                <span className="relative inline-block">
                  AI systems & web platforms
                  <div className="absolute -bottom-2 left-0 w-full h-3 bg-blue-200 -z-10"></div>
                </span>
              </h1>
              <p className="text-lg text-gray-600 max-w-lg">
                Passionate about Artificial Intelligence and Federated Learning.
                I develop intelligent systems and user-friendly web applications
                that solve real-world problems through research and innovation.
              </p>
